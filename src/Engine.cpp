...
{
	const sgfx::GraphicsPipelineCreationDesc pipelineCreationDesc =
	{
	...
	m_pipeline = createGraphicsPipeline(pipelineCreationDesc);
	...
	m_vertexBuffer = createBuffer<sgfx::VertexPosColor>(
		sgfx::BufferCreationDesc
		{
